...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_folder', default='data/train/',
                        type=str, help='folder of training data')
    parser.add_argument('--val_folder', default='data/val/',
    ...
    parser.add_argument('--info_folder', default='data/rig_info_remesh/',
